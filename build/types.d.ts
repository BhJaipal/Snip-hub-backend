...
export type CodeBoxResolvers<ContextType = any, ParentType extends ResolversParentTypes["CodeBox"] = ResolversParentTypes["CodeBox"]> = {
    code?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
    title?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type MutationResolvers<ContextType = any, ParentType extends ResolversParentTypes["Mutation"] = ResolversParentTypes["Mutation"]> = {
    snipAdd?: Resolver<ResolversTypes["returnStats"], ParentType, ContextType, RequireFields<MutationSnipAddArgs, "codeSnip">>;
};
export type QueryResolvers<ContextType = any, ParentType extends ResolversParentTypes["Query"] = ResolversParentTypes["Query"]> = {
    langFind?: Resolver<ResolversTypes["lang"], ParentType, ContextType, RequireFields<QueryLangFindArgs, "langName">>;
    langList?: Resolver<Array<ResolversTypes["lang"]>, ParentType, ContextType>;
    langNames?: Resolver<string[], ParentType, ContextType>;
    titleFind?: Resolver<Maybe<Array<ResolversTypes["lang"]>>, ParentType, ContextType, RequireFields<QueryTitleFindArgs, "title">>;
};
export type LangResolvers<ContextType = any, ParentType extends ResolversParentTypes["lang"] = ResolversParentTypes["lang"]> = {
    codeBoxes?: Resolver<Array<Maybe<ResolversTypes["CodeBox"]>>, ParentType, ContextType>;
    langName?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type ReturnStatsResolvers<ContextType = any, ParentType extends ResolversParentTypes["returnStats"] = ResolversParentTypes["returnStats"]> = {
